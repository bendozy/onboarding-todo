  ...
  return (
    <div className="bg-gray-100 dark:bg-gray-800 rounded-2xl h-screen overflow-hidden relative">
      <div className="flex items-start justify-between">
        <div className="h-screen hidden lg:block my-4 ml-4 shadow-lg relative w-full lg:w-96">
          <div className="bg-white h-full rounded-2xl dark:bg-gray-700">
            <div className="flex items-start justify-center pt-6">Users</div>
            <nav className="mt-6">
              <div>
                <a
        ...
        <div className="flex flex-col w-full pl-0 md:p-4">
          <header className="w-full flex justify-center bg-white  items-center h-16 rounded-2xl mb-4">
